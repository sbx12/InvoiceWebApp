<template>
    <div class="page-add-invoice">
        <div class="columns is-multiline">
            ...
            <div class="column is-12">
                <h2 class="is-sizer-5 mb-4">Client</h2>
                ...
                <div class="box mt-4" v-if="invoice.client">
                    <p>NAME: <strong>{{ invoice.client.name }}</strong></p>
                    <p>NAME: <strong>{{ invoice.client.email }}</strong></p>
                    <p>ADDRESS1: {{ invoice.client.address1 }}</p>
                    <p>ADDRESS2: {{ invoice.client.address2 }}</p>
                    <p>ZIPCODE: {{ invoice.client.zipcode }}</p>
                    <p>PLACE: {{ invoice.client.place }}</p>
                    <p>COUNTRY: {{ invoice.client.country }}</p>
                </div>
